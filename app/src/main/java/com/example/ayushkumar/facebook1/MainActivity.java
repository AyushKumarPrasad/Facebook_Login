package com.example.ayushkumar.facebook1;
...
public class MainActivity extends AppCompatActivity
{
    ...
    private void printKeyHash()
    {
        try
        {
            PackageInfo info = getPackageManager().getPackageInfo("com.example.ayushkumar.facebook1", PackageManager.GET_SIGNATURES);
